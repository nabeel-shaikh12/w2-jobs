...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "inner-content position-relative" }, _attrs))}><div class="top-header"><div class="d-flex align-items-center justify-content-between"><div class="logo order-lg-0">`);
      ...
      _push(`</li></ul></div></nav></div></div></div>`);
    };
  }
};
