...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      }, _attrs))}><div class="inner-content position-relative"><div class="top-header"><div class="d-flex align-items-center justify-content-between"><div class="logo order-lg-0">`);
      ...
      _push(`</div><div class="right-widget ms-lg-0 order-lg-3 ms-auto"><ul class="d-flex align-items-center style-none">`);
      if (!unref(authUser)) {
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("resources/js/Layouts/Default/Two/Header.vue");
