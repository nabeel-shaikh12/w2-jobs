...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      if (!unref(authUser)) {
        _push(ssrRenderComponent(_component_Link, {
          class: "fw-500 login-btn-three dark-style tran3s",
        ...
        if (unref(authUser).role == "admin") {
          _push(`<a${ssrRenderAttr("href", _ctx.route("admin.dashboard"))} class="fw-500 login-btn-three dark-style tran3s">${ssrInterpolate(_ctx.trans("Dashboard"))}</a>`);
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("resources/js/Layouts/Default/Seven/Header.vue");
