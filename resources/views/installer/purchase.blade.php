...
<div class="col-sm-12">
   ...
   <form class="ajaxform_instant_reload" method="post" action="{{ route('install.verify') }}">
      ...
      <div class="form-group mt-5">
         <label class="text-right">License: AAAAAAAA-AAAA-AAAA-AAAA-AAAAAAAAAAAA</label>
         <a href="https://codegood.net" target="_blank" class="float-right text-primary">Thank for buy item in CodeGood.Net </a>
         <input type="text" name="purchase_key" class="form-control" required="" placeholder="AAAAAAAA-AAAA-AAAA-AAAA-AAAAAAAAAAAA" maxlength="36" minlength="30">
      </div>
