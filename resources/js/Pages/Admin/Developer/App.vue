                    ...
                    <form @submit.prevent="update">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <!-- by add john at 2024-5-14 -->
                                <div class="mt-3">
                                    <label class="label">{{ trans('JavaScript Code') }}</label>
                                    <textarea  class="select text-area" name="textcode" v-model="form.TxtAreaInp" placeholder="Write code.." rows="4" cols="65"></textarea>                                 
                                    <SpinnerBtn class="submit_btn" :processing="form.processing" :btn-text="trans('Save Changes')" />
                                </div>
                            </div>
                        </div>
                    </form>
...
const props = defineProps(['segments', 'buttons', 'id', 'tzlist', 'languages', 'textcode', 'appName', 'appDebug', 'timeZone', 'default_lang'])
...
<!-- add text-area style by john at 2024-5-14 -->
<style>
.text-area{
