...
const applicationJobId = ref(null)
...
const showApplication = (apply_id, job_id) => {
  applicationId.value = apply_id
  applicationJobId.value = job_id
...
onUpdated(() => {
  ...
  console.log("props.applicants",props.applicants);

  console.log("applicationId",applicationId);
  console.log("applicationJobId",applicationJobId);
                ...
                <div class="d-flex justify-content-md-end align-items-center">
                  <div class="mt-10 action-dots float-end ms-2">
                    ...
                    <ul class="dropdown-menu dropdown-menu-end">
                      <li>
                        <button
                          @click="showApplication(candidate.id,candidate.opening_id)"
                          class="dropdown-item"
