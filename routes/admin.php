...
use App\Http\Controllers\Admin\ResumeUploadController; // Import the correct controller

Route::group(['prefix' => 'admin', 'as' => 'admin.', 'middleware' => ['auth', 'admin']], function () {

    // Resourceful routes for various models
    ...
    // Dashboard and miscellaneous routes
    ...
    Route::post('candidate/{candidate}/upload-resume', [ADMIN\CandidateController::class, 'uploadResume'])
        ->name('candidate.uploadResume');

    // Route for uploading multiple resumes (if applicable)
    Route::post('/upload-resumes', [ADMIN\ResumeUploadController::class, 'uploadResumes'])
        ->name('upload-resumes');
