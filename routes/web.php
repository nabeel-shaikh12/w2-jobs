...
Route::get('/candidates/{id}/resume', [App\Http\Controllers\Employer\CandidateController::class, 'showResume'])->name('candidates.showResume');
...
Route::get('candidates/download-resume/{id}', [App\Http\Controllers\Employer\CandidateController::class, 'downloadResume'])->name('candidates.downloadResume');
...
Route::middleware('auth')->get('/resume-limit', [App\Http\Controllers\Employer\CandidateController::class, 'checkResumeLimit'])->name('candidates.resume.limit');
...
Route::get('/user/download-limit', [App\Http\Controllers\Employer\CandidateController::class, 'checkResumeLimit'])->name('user.download-limit');
// Route::post('/api/user/download-resume', [App\Http\Controllers\Employer\CandidateController::class, 'downloadResume'])->name('user.download-resume');
//Route::post('/candidates/{username}/download-resume', [\App\Http\Controllers\Employer\CandidateController::class, 'logResumeDownload']);
